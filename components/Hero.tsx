export function Hero() {
  return (
    <div className="mt-[7vh] flex flex-col items-center px-4 text-center pointer-events-none [@media(max-height:560px)]:mt-[3vh] sm:mt-[18vh] sm:px-6 sm:[@media(max-height:560px)]:mt-[6vh]">
